      ...
      <nav className="mx-auto flex max-w-screen-2xl items-center justify-between lg:px-8" aria-label="Global">
        ...
        <div className="flex lg:hidden">
          ...
          <div className="flex items-center">
            <a className="nj-lead font-heading text-white shadow-sm focus-visible:outline focus-visible:outline-0 focus-visible:outline-offset-2 focus-visible:transparent font-bold rounded-2xl bg-primary-700 hover:bg-primary-600 transition-all ease-in text-base py-3 px-4" href="#">Get estimate</a>
          </div>

          <div className="flex items-center ml-2">
            <a href="tel:(705) 230-1765" className="font-heading text-white shadow-sm focus-visible:outline focus-visible:outline-0 focus-visible:outline-offset-2 focus-visible:outline-transparent font-bold text-base py-3.5 px-3 rounded-2xl bg-zinc-800 hover:bg-zinc-700  transition-all ease-in"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
        ...
        {/* Regular CTA*/}
        <div className="flex items-center">
          <a className="nj-lead font-heading text-white shadow-sm focus-visible:outline focus-visible:outline-0 focus-visible:outline-offset-2 focus-visible:transparent font-bold rounded-2xl bg-primary-700 hover:bg-primary-600 transition-all ease-in text-base py-3.5 px-4" href="#">Get estimate</a>
        </div>
        <div className="flex items-center ml-2.5">
          <a href="tel:(705) 230-1765" className="font-heading text-white shadow-sm focus-visible:outline focus-visible:outline-0 focus-visible:outline-offset-2 focus-visible:outline-transparent text-base py-4 px-4 rounded-2xl bg-zinc-800 hover:bg-zinc-700 transition-all ease-in">
